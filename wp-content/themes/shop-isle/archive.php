						...
						<div class="col-sm-8">
							...
							while ( have_posts() ) {
								...
								<div id="post-<?php the_ID(); ?>" <?php post_class("post"); ?> itemscope="" itemtype="http://schema.org/BlogPosting">
									...
									<div class="post-header font-alt post_inside_alt">
																			<div class="post-meta">
											<?php
											shop_isle_posted_on();
											?>
									...
									<div class="post-entry unique_post_page">
										<?php
									...
									<div class="post-more">
										<a href="<?php echo esc_url( get_permalink() ); ?>" class="more-link"><?php _e('Continue reading','shop-isle'); ?></a>
									</div>
