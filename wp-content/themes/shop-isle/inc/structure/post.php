...
if ( ! function_exists( 'shop_isle_post_content' ) ) {
	...
	function shop_isle_post_content() {
		?>
		<div class="post-entry unique_post_page" itemprop="articleBody">
		<?php
		the_content(
			sprintf(
...
if ( ! function_exists( 'shop_isle_posted_on' ) ) {
	...
	function shop_isle_posted_on() {
		...
		//href="' . esc_url( get_day_link(get_post_time('Y'), get_post_time('m'), get_post_time('j')) ) . '" rel="bookmark">'
			echo '<a' . $time_string . '</a>  ';
		endif;
