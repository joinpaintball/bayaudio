...
if ( 'posts' == get_option( 'show_on_front' ) ) {
	...
	if( defined('WCCM_VERISON') ) {
		...
		echo '<section class="module-small wccm-frontpage-compare-list">';
			echo '<h2 class="module-title font-alt product-hide-title"><u>PRODUCTS</u></h2>';
	...
	if($_SESSION['lng'] == "de")
		echo do_shortcode('[parallax-scroll id="324"]');
	else
		echo do_shortcode('[parallax-scroll id="13"]');
		...
		if ( isset($shop_isle_banners_hide) && $shop_isle_banners_hide != 1 ) {
			echo '<section id="products" class="module-small home-banners">';
			echo '<h2 class="module-title font-alt product-hide-title"><u>PRODUCTS</u></h2>';
		} elseif ( isset( $wp_customize ) ) {
			echo '<section id="products" class="module-small home-banners shop_isle_hidden_if_not_customizer">';
		}
							...
							echo '<div class="row shop_isle_bannerss_section">';
								...
								foreach($shop_isle_banners_decoded as $shop_isle_banner) {
									...
									if ( !empty($shop_isle_banner->image_url) ) {
										...
										if($shop_isle_banner->subtext == "English" && ($_SESSION['lng'] == "en" || !isset($_SESSION['lng']))){
											
											
											
											echo '<div style="padding-right:0px; padding-left:0px;" class="col-xs-6 col-sm-3 imagebox"><div class="content-box mt-0 mb-0"><div id="az" class="content-box-image">';
											if ( !empty($shop_isle_banner->link) ) {
												...
												if (function_exists ( 'icl_t' ) && !empty($shop_isle_banner->id)){
													...
													echo '<img class="top" src="wp-content\themes\shop-isle\assets\images\explore.png">';
													echo '<a href="' . esc_url( $shop_isle_banner_link ) . '"><img class="bottom" src="' . esc_url( $shop_isle_banner_image_url ) . '"></a>';
												} else {	
													echo '<img class="top" src="wp-content\themes\shop-isle\assets\images\explore.png">';
													echo '<a href="' . esc_url( $shop_isle_banner->link ) . '"><img class="bottom" src="' . esc_url( $shop_isle_banner->image_url ) . '"></a>';
												}
											}
											else {
												if (function_exists ( 'icl_t' ) && !empty($shop_isle_banner->id)){
											...
											echo '</div></div>';
											echo '<div class="product_text_holder">';
												echo '<a class="product_title" style="font-size:18px;">' . $shop_isle_banner->text . '</a>';
												echo '<a class="product_title">...</a>';
												echo '<a class="product_title">' . $shop_isle_banner->description . '</a>';
											echo '</div></div>';
											
											
										}else if($shop_isle_banner->subtext == "Deutsch" && $_SESSION['lng'] == "de"){
											echo '<div style="padding-right:0px; padding-left:0px;" class="col-xs-6 col-sm-3 imagebox"><div class="content-box mt-0 mb-0"><div id="az" class="content-box-image">';
											if ( !empty($shop_isle_banner->link) ) {
		...
		/*Parallax pages: About->Products->Technology*/
		
		
		
		if($_SESSION['lng'] == "de"){
			echo do_shortcode('[parallax-scroll id="322"]');
			echo do_shortcode('[parallax-scroll id="321"]');
			echo do_shortcode('[parallax-scroll id="320"]');
		}
		else{
			echo do_shortcode('[parallax-scroll id="24"]');
			echo do_shortcode('[parallax-scroll id="28"]');
			echo do_shortcode('[parallax-scroll id="43"]');
		}
		/*Contact Page*/
		echo do_shortcode('[contactwid id="45" ajax="No"]');
		echo '<section id="newletter" class="module-small home-banners no_bg_pos">';
		echo '<div class="container">';
			if($_SESSION['lng'] == "de")
				echo do_shortcode('[parallax-scroll id="319"]');
			else
			echo do_shortcode('[parallax-scroll id="51"]');
			
			echo '<div class="container email-container">';
				echo do_shortcode('[subscribewid id="46" ajax="No"]');				
			echo '</div>';
		...
		echo '<div class="container">';
			...
			echo '</div>';
		echo '</div>';
		echo '<div class="container socil_bar_container">';
			echo '<div class="social_bar">';
			echo '<ul class="list-inline center-block text-center social_lu">';
				echo '<li class="social_li"><a href="#">TWITTER</a></li>';
				echo '<li class="social_li"><a href="#">FACEBOOK</a></li>';
				echo '<li class="social_li"><a href="#">GOOGLE+</a></li>';
				echo '<li class="social_li"><a href="#">INSTAGRAM</a></li>';
			echo '</ul>';
			echo '</div>';
			echo '<div class="copyright_text"><a>COPYRIGHT © 2016 BAYZ AUDIO</a></div>';
			echo '<a href="#totop"><div class="icon_bar"></div></a>';
		echo '</div>';	
		echo '</div>';
		echo '</section>';
						...
						if( !empty($shop_isle_products_title) ) {
							echo '<div class="row">';
								echo '<div class="col-sm-6 col-sm-offset-3">';
									echo '<h2 class="module-title font-alt product-hide-title"><u>'.$shop_isle_products_title.'</u></h2>';
								echo '</div>';
							echo '</div>';
						}
